...
type CardComerciosProps = {
  comercios: ComerciosType;
};

const CardComercios: React.FC<CardComerciosProps> = ({ comercios }) => {
  const openWhatsApp = () => {
    // Reemplazar por número de WhatsApp
    Linking.openURL(`tel:${comercios.telefono}`);
  };
  ...
  return (
    <View style={styles.CardContainer}>
      ...
      <View style={styles.cardInfo}>
         <Text style={styles.textTitle}>{`${comercios.nombre} ${comercios.apellido}`}</Text>
         <Text style={styles.textDescripcion}>{comercios.descripcion}</Text>
      </View>
